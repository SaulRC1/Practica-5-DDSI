...
public class Monitor implements Serializable {
    ...
    @XmlTransient
    public Set<Actividad> getActividadesResponsables() {
        return actividadesResponsable;
    }

    public void setActividadesResponsable(Set<Actividad> actividadSet) {
        this.actividadesResponsable = actividadSet;
    }
